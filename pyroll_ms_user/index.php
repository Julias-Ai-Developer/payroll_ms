...
<div class="mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Total Employees -->
        <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-smooth p-6 border border-slate-200 hover:shadow-glow transition-all duration-300 hover-lift group">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-slate-500 text-sm font-medium mb-1">Total Employees</p>
                    <p class="text-3xl font-bold text-slate-800"><?php echo $totalEmployees; ?></p>
                    <div class="flex items-center mt-2 text-sm text-slate-500">
                        <i class="fas fa-user-plus text-xs mr-1"></i>
                        <span>Active workforce</span>
                    </div>
                </div>
                <div class="p-4 rounded-2xl bg-blue-100 text-blue-600 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-smooth p-6 border border-slate-200 hover:shadow-glow transition-all duration-300 hover-lift group">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo $totalPayroll; ?></p>
                    <div class="flex items-center mt-2 text-sm text-slate-500">
                        <i class="fas fa-history text-xs mr-1"></i>
                        <span>All-time records</span>
                    </div>
                </div>
                <div class="p-4 rounded-2xl bg-emerald-100 text-emerald-600 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-smooth p-6 border border-slate-200 hover:shadow-glow transition-all duration-300 hover-lift group">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800">UGX <?php echo number_format($totalSalary, 0); ?></p>
                    <div class="flex items-center mt-2 text-sm text-slate-500">
                        <i class="fas fa-wallet text-xs mr-1"></i>
                        <span>All-time expenditure</span>
                    </div>
                </div>
                <div class="p-4 rounded-2xl bg-violet-100 text-violet-600 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-smooth p-6 border border-slate-200 hover:shadow-glow transition-all duration-300 hover-lift group">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo $currentMonthCount; ?></p>
                    <div class="flex items-center mt-2 text-sm text-slate-500">
                        <i class="fas fa-calendar-check text-xs mr-1"></i>
                        <span>This month</span>
                    </div>
                </div>
                <div class="p-4 rounded-2xl bg-amber-100 text-amber-600 group-hover:scale-110 transition-transform duration-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <!-- Average Salary -->
        <div class="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-smooth p-6 border border-blue-100">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800">UGX <?php echo number_format($avgSalary, 2); ?></p>
        ...
        <div class="bg-gradient-to-br from-white to-emerald-50 rounded-2xl shadow-smooth p-6 border border-emerald-100">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-800">UGX <?php echo number_format($monthSalary, 2); ?></p>
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-smooth p-6 border border-slate-200">
            ...
            if ($recentResult->num_rows > 0) {
                ...
                while ($row = $recentResult->fetch_assoc()) {
                    ...
                    echo '<p class="font-semibold text-slate-800">UGX ' . number_format($row['net_salary'], 2) . '</p>';
